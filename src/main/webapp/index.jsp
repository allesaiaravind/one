...
<body>
	...
	<h1 style="color: pink; font-size: 40px;" align="center">WE ARE SUCCESSFULLY aaaaaaN</h1>
	<h1 style="color: red; font-size: 40px;" align="center">THIS IS APPaaa DEPLOYMENT USING TOMCAT sai arrrr</h1>
